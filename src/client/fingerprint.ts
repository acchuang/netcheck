...
export const FingerprintDetector = {
    ...
    try {
      ...
      return {
        ...
        items: [
          {
            label: 'Hash',
            i18nKey: 'fp.canvasHash',
            value: hash.slice(0, 16) + '\u2026',
            entropy: 'high',
          },
        ],
      };
    ...
    try {
      ...
      if (!gl)
        return {
          name: 'WebGL',
          i18nKey: 'fp.webgl',
          items: [{ label: 'Supported', i18nKey: 'fp.webglSupport', value: 'No', entropy: 'low' }],
        };
  ...
  detectScreen(): FingerprintCategory {
    const items: FingerprintItem[] = [
      {
        label: 'Resolution',
        i18nKey: 'fp.screenRes',
        value: `${screen.width}\u00d7${screen.height}`,
        entropy: 'medium',
      },
      {
        label: 'Color Depth',
        i18nKey: 'fp.colorDepth',
        value: `${screen.colorDepth}-bit`,
        entropy: 'low',
      },
      {
        label: 'Pixel Ratio',
        i18nKey: 'fp.pixelRatio',
