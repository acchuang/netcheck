export const CF_POPS: Record<string, [string, number, number]> = {
  ...
  ARN: ['Stockholm', 59.65, 17.94],
  HEL: ['Helsinki', 60.32, 24.95],
  CPH: ['Copenhagen', 55.62, 12.66],
  OSL: ['Oslo', 60.19, 11.1],
  DUB: ['Dublin', 53.43, -6.27],
  LIS: ['Lisbon', 38.77, -9.13],
  PRG: ['Prague', 50.1, 14.26],
  BRU: ['Brussels', 50.9, 4.48],
  MRS: ['Marseille', 43.44, 5.22],
  HAM: ['Hamburg', 53.63, 9.99],
  MUC: ['Munich', 48.35, 11.79],
  JNB: ['Johannesburg', -26.14, 28.25],
  CPT: ['Cape Town', -33.97, 18.6],
  NBO: ['Nairobi', -1.32, 36.93],
  LOS: ['Lagos', 6.58, 3.32],
  CAI: ['Cairo', 30.12, 31.41],
  DOH: ['Doha', 25.26, 51.57],
  DXB: ['Dubai', 25.25, 55.36],
  TLV: ['Tel Aviv', 32.01, 34.89],
  IST: ['Istanbul', 41.26, 28.74],
  KIX: ['Osaka', 34.43, 135.23],
  FUK: ['Fukuoka', 33.59, 130.45],
  CKG: ['Chongqing', 29.72, 106.64],
  CTU: ['Chengdu', 30.58, 103.95],
  PVG: ['Shanghai', 31.14, 121.81],
