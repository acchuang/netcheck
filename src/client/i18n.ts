...
const en = {
  ...
  "about.feat.adblock.desc": "Runs 25+ tests across 6 categories with weighted scoring, detects filter lists, identifies which blocker you're running, and tests any custom URL. Fingerprint resistance is measured separately, from the browser APIs themselves.",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  "about.feat.adblock.desc": "在 6 個類別中執行 25+ 項加權評分測試，偵測過濾清單、辨識您使用的攔截器，並可測試任何自訂網址。指紋辨識抵抗力則直接以瀏覽器 API 另行量測。",
