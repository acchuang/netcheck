...
const en = {
  ...
  "adblock.advice.analytics.desc": "Analytics trackers collect data about your browsing behavior. Privacy-focused filters are needed.",
  ...
  "adblock.advice.annoyances.desc": "Cookie consent popups are annoying but some are also used for tracking. Dedicated filters handle these.",
  ...
  "adblock.advice.banner.desc": "Banner ads are visual advertisements displayed on pages. Standard filter lists cover these.",
  ...
  "adblock.advice.contextual.desc": "Contextual ads are embedded directly in page content. Most ad blockers handle these well.",
  ...
  "adblock.advice.devtools.desc": "Error monitoring scripts report exceptions back to services. These can leak browsing data.",
  ...
  "adblock.advice.fingerprint.desc": "Fingerprinting scripts collect unique device characteristics to identify you across sites.",
  ...
  "adblock.advice.social.desc": "Social media buttons and widgets often include tracking code. Blocking these protects your privacy.",
  ...
  "adblock.suggestGaps": "{0} of {1} categories have unblocked trackers. Consider adding more filter lists or switching to a more comprehensive ad blocker.",
