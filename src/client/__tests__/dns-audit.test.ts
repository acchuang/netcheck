...
const mockHijackData = [
  { resolver: "Cloudflare", aRecords: ["104.18.1.2"], expectedARecords: ["104.18.1.2"], nxdomainTampered: false, ttlAnomaly: false, trustScore: 95, summary: "clean" as const },
  { resolver: "Quad9", aRecords: ["1.2.3.4"], expectedARecords: ["104.18.1.2"], nxdomainTampered: true, ttlAnomaly: true, trustScore: 30, summary: "tampered" as const },
  { resolver: "OpenDNS", aRecords: [], expectedARecords: ["104.18.1.2"], nxdomainTampered: false, ttlAnomaly: true, trustScore: 60, summary: "suspicious" as const },
];

const mockEcsData = [
  { resolver: "Cloudflare", ecsDetected: false, ecsPrefix: null, ecsAddress: null, rating: "none" as const },
  { resolver: "Google", ecsDetected: true, ecsPrefix: 32, ecsAddress: "203.0.0.0", rating: "significant" as const },
  { resolver: "Quad9", ecsDetected: true, ecsPrefix: 16, ecsAddress: "45.0.0.0", rating: "moderate" as const },
];
