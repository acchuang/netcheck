  ...
  return data
    .map((r) => {
      ...
      return `<div class="dns-check-item fade-in">
        <svg class="check-icon ${icon}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${iconSvg}</svg>
