...
export const zhTW = {
  ...
  'quality.captive.label': '強制入口網頁',
  'quality.captive.ok': '未偵測到強制入口網頁',
  'quality.captive.captive': '疑似強制入口網頁或 DNS 注入',
  'quality.captive.blocked': '連線檢查被封鎖或離線',
  'quality.enabled': '已開啟',
  ...
  'quality.tlsFactor.tip': 'TLS 連線的協定與加密強度。',
  'quality.serverRttFactor.tip': '到伺服器的往返時間（越低越快）。',
  'quality.connTypeFactor.tip': '你的連線方式（Wi-Fi、行動網路、乙太網路）及其實際速度。',
  'quality.stabilityFactor.tip': '負載下的連線穩定性 — 延遲、抖動與封包遺失。',
  ...
  'networkChange.cellular': '行動網路',
  'networkChange.offline': '離線',
  'networkChange.changed': '網路已切換為{0}',
  'networkChange.online': '網路已恢復',
  'networkChange.offlineToast': '您已離線',
  'network.title': '網路地圖',
  ...
  'cookie.httpOnlyNote':
    '伺服器設定的 HttpOnly Cookie 出於安全原因不可被 JavaScript 讀取，未顯示。',
  ...
  'dns.sug.ecs.type': '隱私',
  'dns.sug.ecs.desc':
    '您的 DNS 解析器正在透過 ECS 洩漏您的 IP 子網路。請啟用 DNS-over-HTTPS 以防止此洩漏。',
  ...
  'speed.sug.packetLoss.desc': '高丟包率表示連線不穩定。檢查WiFi干擾、網線故障或ISP問題。',
  ...
  'speed.sug.jitter.desc': '高抖動會導致延遲不一致。嘗試有線連接或檢查網絡擁塞。',
  ...
  'ai.privacyBody':
    '雲端 AI 會將您的測試結果傳送到 Cloudflare 進行分析。不會儲存或記錄任何資料。僅傳送您的網路測試指標（IP、速度、DNS 配置、TLS 詳細資訊）—— 不包含個人資料。您也可以使用完全在本機運行的本機 AI。',
