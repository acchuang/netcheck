...
export const gradeKeys: Record<string, string> = {
  Exceptional: 'speed.grade.exceptional',
  Excellent: 'speed.grade.excellent',
  'Very Good': 'speed.grade.veryGood',
  Good: 'speed.grade.good',
  Average: 'speed.grade.average',
  'Below Average': 'speed.grade.belowAvg',
  Slow: 'speed.grade.slow',
  Unknown: 'speed.grade.unknown',
